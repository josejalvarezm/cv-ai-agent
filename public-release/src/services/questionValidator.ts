  ...
  private readonly nonTechnicalPatterns: ValidationPattern[] = [
    {
      ...
      type: 'compensation',
      suggestion: "Try asking: 'What experience does the candidate have with enterprise systems?' or 'What technologies has the candidate used in fintech?'"
    },
    {
    ...
    },
    {
      ...
      type: 'employment',
      suggestion: "Try asking: 'What are the candidate's key technical strengths?' or 'What projects has the candidate worked on?'"
    },
    {
