...
- Related_project: Acme Corp national campaign platform

Output answer:
"With 5+ years of advanced experience in Full‑Stack Service Decomposition at Acme Corp, the candidate broke down monolithic applications into modular services. This enabled teams to deploy independently, cutting release cycles from weeks to days and ensuring campaign responsiveness during national elections."`
            },
