...
const COMMON_WORDS = new Set([
  ...
  'qualified','jose','the candidate','candidate','profile','background','resume','cv','capabilities','competent','suitable',
...
export function isWithinBusinessHours(bypassPhrase?: string): BusinessHoursCheck {
  ...
  if (bypassPhrase && bypassPhrase.toLowerCase().includes('i am the candidate')) {
    return {
      isWithinHours: true,
