...
export class PromptBuilderService implements IPromptBuilder {
  ...
  buildSystemPrompt(projectDetection?: ProjectDetectionResult): string {
    ...
    return `You are a recruiter-facing assistant answering questions about the candidate's professional profile. Respond in FIRST PERSON as the candidate using British English.
...
✅ GOOD: "I delivered Angular applications with 40% faster load times at Acme Corp."
