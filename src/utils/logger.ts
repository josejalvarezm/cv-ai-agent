 ...
 *
 * Features:
 * - Category-based organization (API, Service, Repthe candidatery, Cache, Vector, Database)
...
export class Logger {
  ...
  // Repthe candidatery Logging
  repthe candidatery(message: string, context?: LogContext): void {
    this.log(message, 'debug', 'Repthe candidatery', { context });
  }

  repthe candidateryError(message: string, context?: LogContext, metadata?: Record<string, any>): void {
    this.log(message, 'error', 'Repthe candidatery', { context, metadata });
  }
